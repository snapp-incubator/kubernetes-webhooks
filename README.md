...
```bash
helm repo add <alias> https://snapp-incubator.github.io/kubernetes-webhooks
```
...
To install the `kubernetes-webhooks` chart:

    helm install <my-chart-name> <alias>/kubernetes-webhooks
